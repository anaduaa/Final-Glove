...
//Serial.println(analogRead(FLEX_PIN1));
Serial.println(analogRead(FLEX_PIN5));
...
if(((angle1>=30)&&(angle1<=65))&&((angle2>=30)&&(angle2<=65))&&((angle3>=30)&&(angle3<=65))&&((angle4>=30)&&(angle4<=60))&&((angle5>=0)&&(angle5<=30))&&(digitalRead(7) ==LOW )){
 // Serial.println("C");
  printfun('C');
}
...
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=60)&&(angle3<=90))&&((angle4>=60)&&(angle4<=90))&&((angle5>=40)&&(angle5<=90))&&(gesture!=2)&&(digitalRead(7)==LOW)){
printfun('E');
...
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=0)&&(angle3<=20))&&((angle4>=0)&&(angle4<=20))&&((angle5>=0)&&(angle5<=90))&&(gesture==1)){
...
//
//}
if(((angle1>=70)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=0)&&(angle3<=20))&&((angle4>=0)&&(angle4<=20))&&((angle5>=30)&&(angle5<=60))&&(gesture!=1)) {
printfun('K');



}
if(((angle1>=55)&&(angle1<=90))&&((angle2>=55)&&(angle2<=90))&&((angle3>=55)&&(angle3<=90))&&((angle4>=0)&&(angle4<=25))&&((angle5>=0)&&(angle5<=25))&&(gesture!=1&&(gesture!=3))&&(gesture==4)){
 printfun('L'); 
...
////printfun('N');
//}
if(((angle1>=0)&&(angle1<=65))&&((angle2>=0)&&(angle2<=65))&&((angle3>=0)&&(angle3<=65))&&((angle4>=50)&&(angle4<=90))&&((angle5>=0)&&(angle5<=60))&&(digitalRead(7) ==HIGH )){


  //Serial.println('O');
printfun('O');
}
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=0)&&(angle3<=30))&&((angle4>=0)&&(angle4<=15))&&((angle5>=0)&&(angle5<=40))&&(gesture==3)){
printfun('P');
...
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=0)&&(angle3<=20))&&((angle4>=0)&&(angle4<=20))&&((angle5>=0)&&(angle5<=20))&&(gesture!=1)&&(digitalRead(7)==HIGH)){
printfun('R');
//Serial.println('R');
}
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=60)&&(angle3<=90))&&((angle4>=60)&&(angle4<=90))&&((angle5>=30)&&(angle5<=60))&&(digitalRead(7) == HIGH )){

 // Serial.println('S');
printfun('S');
}
if(((angle1>=60)&&(angle1<=90))&&((angle2>=60)&&(angle2<=90))&&((angle3>=60)&&(angle3<=90))&&((angle4>=20)&&(angle4<=50))&&((angle5>=0)&&(angle5<=40))&&(digitalRead(8)==HIGH)&&(digitalRead(7)==LOW)){
//Serial.println('T');
...
//else if(((angle1>=50)&&(angle1<=72))&&((angle2>=45)&&(angle2<=90))&&((angle3>=35)&&(angle3<=75))&&((angle4>=0)&&(angle4<=10))&&((angle5>=45)&&(angle5<=80))&&(((xadc>=412)&&(xadc<=418))&&((yadc>=340)&&(yadc<=360))))
//printfun('Z');
